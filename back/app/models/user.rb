class User < ApplicationRecord
  ...
  # throughは、前行で定義した関連名を使用。sourceで、UserRelationモデルに記載している関連名receiverを指定して、receiver情報を戻り値にする。
  ...
  has_many :messages_reads, class_name: 'messages_reads', foreign_key: 'reader_id', dependent: :destroy
